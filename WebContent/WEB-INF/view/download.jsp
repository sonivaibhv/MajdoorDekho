                ...
                <div class="navbar navbar-default" role="navigation">
                    <div class="container">
                        <div class="navbar-header">
                                ...
                                <a href="#" class="navbar-brand"><img src="images/a.PNG
                                " alt="MajdoorDekho" title="MajdoorDekho" /></a>
                        </div>
                        <div class="navbar-collapse collapse" id="templatemo-nav-bar">
                            <ul class="nav navbar-nav navbar-right" style="margin-top: 40px;">
                                 <li><a href="home">HOME</a></li>
                                <li><a href="about">ABOUT</a></li>
                                <li><a href="register">REGISTER A LABOUR</a></li>
			 ...
			 <div class="row">
                    <div class="templatemo-line-header" >
                        <div class="text-center">
                            <hr class="team_hr team_hr_left hr_gray"/><span class="txt_darkgrey">Download App</span>
