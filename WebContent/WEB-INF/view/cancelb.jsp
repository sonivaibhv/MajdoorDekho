                    ...
                    <div class="container">
                        ...
                        <div class="navbar-collapse collapse" id="templatemo-nav-bar">
                            <ul class="nav navbar-nav navbar-right" style="margin-top: 40px;">
                                 <li><a href="profile">BOOK A LABOUR</a></li>
                                <li class="active"><a href="cancelb">CANCEL BOOKING</a></li>
 ...
 <div class="row">
                    <div class="templatemo-line-header" >
                        <div class="text-center">
                            <hr class="team_hr team_hr_left hr_gray"/><span class="txt_darkgrey">Cancel Booking</span>
...
<div id="login">
  ...
  <h1>MajdoorDekho</h1>
  <form action="cancelb" method="post">
    <input type="text" name="bookingNo" placeholder="Enter Your Booking Pin no"  required="required"/>
	 <!-- <label>
	  <input type="checkbox" name="remember_me" id="remember_me">
	  I accept  <a href="http://www.MajdoorDekho.com/"> MajdoorDekho </a>Terms & Condition
      </label> -->
       <input type="submit" name="cbbutton" value="confirm"/>
