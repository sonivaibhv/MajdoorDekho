            ...
            <div class="container">
                <div class="subheader">
                    ...
                    <div id="email" class="pull-center">
							...
							<li class="active"><a href="login?action=as"> Login</a></li>	
 ...
 <div class="row">
                    <div class="templatemo-line-header" >
                        <div class="text-center">
                            <hr class="team_hr team_hr_left hr_gray"/><span class="txt_darkgrey">Login</span>
...
<div id="login">
  ...
  <form action="login" method="post">
	...
	<a href="signup"><h4>Create a new user</h4></a>
