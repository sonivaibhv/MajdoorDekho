 ...
 <div class="row">
                    <div class="templatemo-line-header" >
                        <div class="text-center">
                            <hr class="team_hr team_hr_left hr_gray"/><span class="txt_darkgrey">Rate Labour</span>
...
<div id="login">
  ...
  <h1>MajdoorDekho</h1>
  <form>
    <input type="text" placeholder="Enter the labour i.d." required="required"/>
	<select>
	<option>rate labour</option>
		<option>5</option>
			<option>4</option>
				<option>3</option>
					<option>2</option>
     ...
     <!-- <label>
	  ...
	  <a href="#">
       <input type="button" name="rbutton" value="confirm"/>
</a>	   
  </form>
</div>
